...
@section('content')
    ...
    <div class="row g-4">
        <div class="col-6">
            ...
            <input type="text" name="name" id="id-1" class="form-control @error('name') is-invalid @enderror">
            @error('name')
        ...
        <div class="col-6">
            ...
            <input type="text" name="description" id="id-2" class="form-control @error('description') is-invalid @enderror">
            @error('description')
            <span class="invalid-feedback">{{$message}}</span>
            @enderror
        </div>
        ...
        <div class="col-6">
            ...
            <input type="text" name="price" id="id-4" class="form-control @error('price') is-invalid @enderror">
            @error('price')
            <span class="invalid-feedback">{{$message}}</span>
            @enderror
        </div>
