                    ...
                    <table class="table table-borderless table-shopping-cart">
                        ...
                        @foreach($products as $product)
                            <tr>
                                ...
                                <td>
                                    <div class="price-wrap"> <var class="price">R$ {{$product['price']}}</var></div>
                                </td>
                                <td class="text-right d-none d-md-block"> <a data-original-title="Save to Wishlist" title="" href="" class="btn btn-red" data-toggle="tooltip" data-abc="true"> <i class="fa fa-heart"></i></a> <a href="" class="btn btn-red" data-abc="true"> Remove</a> </td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
